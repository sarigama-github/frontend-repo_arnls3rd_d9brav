...
export default function Section({ id, eyebrow, title, description, children }) {
  return (
    <section id={id} className="relative py-24 bg-[#05030B]">
      <div className="absolute inset-0 bg-[radial-gradient(600px_200px_at_top_left,rgba(56,189,248,0.12),transparent)]" />
      <div className="relative max-w-7xl mx-auto px-6">
        <motion.div
          ...
          className="max-w-3xl"
        >
          {eyebrow && <p className="text-sky-400 text-sm font-semibold tracking-wider uppercase">{eyebrow}</p>}
